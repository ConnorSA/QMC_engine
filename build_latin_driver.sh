...
myprogramfiles="constants.f90 component_functions.f90 basis_functions.f90 param_search.f90 MCMC.f90  read_data.f90 electron_density.f90 calc.f90 netcdf_file.f90 latin_driver.f90"
# 
